...
- 🔭 Me centro en construir **experiencias web completas** y claras (de idea a despliegue).
- 💡 Me comunico sin tecnicismos para facilitar el progreso o el trabajo en equipo.
- 🚀 Diseño arquitectura y experiencia orientada a que tu producto crezca orgánicamente.
- ✍️ Priorizo el rendimiento, la estabilidad y la usabilidad utilizando tecnologías modernas.
- 🌐 Puedes ver todo sobre mí y los demos de mis proyectos en mi [Portafolio Personal](https://rica-2000.github.io).
...
**DevOps, Móvil y Otras Herramientas:** <br>
...
A lo largo de mi carrera he construido +15 proyectos, entre ellos:

- **CiComp Overflow:** Plataforma colaborativa académica (Next.js, TypeScript, PostgreSQL, Redis, Docker).
- **Tienda E-Commerce:** Solución completa MEAN (Angular, Node, Express, MongoDB) con gestión admin, carrito de compras y JWT.
- **Ecosistema Laravel:** Colección de sistemas como **MediCare** (Sistema de Citas Médicas), **Es-Cine** (Gestión de carteleras) y de control escolar o de biblioteca (Arquitecturas CRUD robustas con roles).
- **PlanetFutbol:** Aplicación móvil en Flutter con consumo de APIs deportivas y Firebase en el backend.
